...
public class LedgerReceiver0 {
	...
	public LedgerReceiver0() throws IOException {
	...
	public static void main(String[] args) throws IOException {
		LedgerReceiver0 receiver = new LedgerReceiver0();
	...
	/**
	  ...
	  public static byte[] decrypt(byte[] text, PublicKey key) {
	    ...
	    System.out.println("Inside the decrypt method");
	   ...
	   public void run()
	   {
	      ...
	      try
	      {
	         ...
	         while (true)
	         {
	            ...
	            final byte[] plainText = decrypt(received, publicKey);
	    		...
	    		do
	    		{
	    			...
	    			lNonceStr.concat(new String(received));
