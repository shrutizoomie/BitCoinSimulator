...
public class MulticastReceiver2 {
	...
	public MulticastReceiver2() throws IOException 
        {
	...
	{  
	   ...
	   private InetAddress address;
            ...
            // File Names
            private String blockFileName = "blockchain_miner2";
            ...
            private BitFedBlockChain blockChainMiner2;
	   ...
	   public RecieverListenerThread(InetAddress address, int socketNum1, int socketNum2, int socketNum3)
	   {
                ...
                try
		{
                    ...
                    if (checkBlockchainFile)
                    {
                            ...
                            this.blockChainMiner2 = (BitFedBlockChain) in.readObject();
                            in.close();
                    }
                    else
                    {
                            blockChainMiner2 = new BitFedBlockChain();
                    }
		}
		catch (Exception e)
		{
	   ...
	   public void run()
	   {
               try {
                   ...
                   while (true)
                   {
                       ...
                       System.out.println("Inside Multicast receiver 2");
                       ...
                       packet = new DatagramPacket(buf, buf.length);
                        ...
                        if (null != transaction)
                        {
                            ...
                            if (verifySign.isVerified())
                            {
                                 ...
                                 if (result)
                                 {
                                    blockChainMiner2.addBlock(unconfirmedBlock.block);
                                    ...
                                    byte[] data = SerializationUtils.serialize((Serializable) blockChainMiner2);
                        ...
                        {
                            System.out.println("Packet is length");
                        }
                        else
                        {
                            BitFedBlockChain recvdBlock = (BitFedBlockChain) SerializationUtils.deserialize(packet.getData());
                            
                            if (null != recvdBlock)
                            {
                                System.out.println("Broadcasted block is received: Need to verify and include in block chain");
                            }
                        }
		...
		try
		{
			...
			out.writeObject(this.blockChainMiner2);
			out.close();
		}
		catch (Exception e)
		{
